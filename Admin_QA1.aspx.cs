...
public partial class Admin_QA1 : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        cmd.CommandText = "Select * from ContactAdmin";
    ...
    protected void Grid_DeleteCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        cmd.CommandText = "Delete from ContactAdmin where Name='" + Name + "'";
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
            ...
            string query = "INSERT into Admin_Response(Question, Email, Answer) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "')";
            SqlCommand cmd1 = new SqlCommand(query, con);
            cmd1.ExecuteNonQuery();
            con.Close();
            Label3.Text = "Response Submitted Succesfully";
        ...
        string strSelect = "SELECT Question,Email,Answer FROM Admin_Response WHERE Email='" + TextBox2.Text + "'";
        ...
        if (dsPwd.Tables[0].Rows.Count > 0)
        {
            ...
            loginInfo.Body = "Dear User,<br /><br />Thanking you for contacting SPT Education Team. We are always here to Answer your questions.<br /><br />Here is your Response from SPT Administrator:<br /><br />Question: " + dsPwd.Tables[0].Rows[0]["Question"] + "<br><br>Answer: " + dsPwd.Tables[0].Rows[0]["Answer"] + "<br /><br />Regards,<br />SPT Administrator";
