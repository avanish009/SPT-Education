...
<script>    (function (d, s, id) {
    ...
    <div class="wrapper col2">
        ...
        <div class="wrapper col3">
            <div id="breadcrumb">
                <ul>
                    <li class="first"><b>&nbsp;Select The Files to Download</b></li>
                </ul>
            </div>
        </div>
        <div class="wrapper col5">
            <div id="container">
                <h1><a href="DownloadNotes.aspx">Notes</a></h1>
                <h1><a href="DownloadCodes.aspx">Codes</a></h1>
                <h1><a href="DownloadProject.aspx">Projects</a></h1>
