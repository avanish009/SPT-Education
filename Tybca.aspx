<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tybca.aspx.cs" Inherits="Tybca" %>
                ...
                <div>
                    ...
                    <table width="98%" align="center" border="0" cellspacing="0" cellpadding="2" style="margin-left: 5px" class=" result_tbl_brd">
                        <tbody>
                            ...
                            <tr>
                                <td style="padding-left: 15px" class="result_in">Software Engineering</td>
                                <td style="padding-left: 15px" class="resultin1">5000</td>
                            </tr>
                            <tr>
                                <td style="padding-left: 15px" class="result_in">Building Web Portals through 
                                    ASP.NET</td>
                                <td style="padding-left: 15px" class="resultin1">5500</td>
                            </tr>
                            <tr>
                                <td style="padding-left: 15px" class="result_in">Enterprise solutions using J2EE</td>
                                <td style="padding-left: 15px" class="resultin1">5500</td>
                            </tr>
                            <tr>
                                <td style="padding-left: 15px" class="result_in">Statistical Techniques</td>
                                <td style="padding-left: 15px" class="resultin1">3000</td>
                            </tr>
                            <tr>
                                <td style="padding-left: 15px">Operating Systems</td>
                ...
                <div>
                    ...
                    <table width="98%" align="center" border="0" cellspacing="0" cellpadding="2" style="margin-left: 5px" class="result_tbl_brd">
                        <tbody>
                            ...
                            <tr>
                                <td style="padding-left: 15px" class="auto-style2">Project (BCA)&nbsp; [Out of 
                                    (300)]</td>
                                <td style="padding-left: 15px" class="auto-style1">6000</td>
                            </tr>
                        </tbody>
                    </table>
                    <p style="margin-left: 5px; margin-right: 5px">
                ...
                <table width="98%" align="center" border="0" cellspacing="0" cellpadding="2" style="margin-left: 5px" class="result_tbl_brd">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 15px" class="resultin1">21000</td>
                            <td style="padding-left: 15px" class="resultin1">2000</td>
                        </tr>
                        <tr>
                            <td style="padding-left: 15px" class="result_in">Sem V (only programing)</td>
                            <td style="padding-left: 15px" class="resultin1">10000</td>
                            <td style="padding-left: 15px" class="resultin1">1000</td>
                        </tr>
                        <tr>
                            <td style="padding-left: 15px">Sem V + VI [All (5 + 1 = 6) subjects]</td>
                            <td style="padding-left: 15px" class="result_in2">25000</td>
                            <td style="padding-left: 15px" class="result_in2">2500</td>
                        </tr>
                    </tbody>
                </table>
                <br>
