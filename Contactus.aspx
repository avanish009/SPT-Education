        ...
        <div id="topbar">
         ...
         <div class="wrapper col5">
            <div id="container">
                <div id="content">
                    <h1>Contact Us</h1>
                    <p>We are here to answer any Questions you may Have about your Subjects or Projects. Reach out to us and we'll respond as soon as we can</p>
                    <p>Even if there is something you always want to know about your Academics & can't find it on SPT Education, Let us know and we promise we'll do our best to help you out.</p>
                    &nbsp;
                    <br /><br /><br />
                    ...
                    <h2>Ask Your Queries & We will contact You</h2>
                    <div id="respond">
                        
                            <p>
                                <asp:TextBox ID="TextBox1" runat="server" placeholder="Name"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="TextBox1" runat="server" ErrorMessage="Enter Name" ></asp:RequiredFieldValidator>
                            </p>
                            <p>
                            ...
                            <p>
                                <asp:TextBox ID="TextBox3" runat="server" placeholder="Mobile" MaxLength="10"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="TextBox3" runat="server" ErrorMessage="Enter Mobile Number" ></asp:RequiredFieldValidator>
                                &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server"
                                    ControlToValidate="TextBox3" ErrorMessage="Enter A Valid Mobile Number"
                                    ValidationExpression="[0-9]{10}" ></asp:RegularExpressionValidator>
                            </p>
                            <p>
                                <asp:TextBox ID="TextBox4" runat="server" placeholder="Subject" MaxLength="50"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator9" InitialValue="0" ControlToValidate="TextBox4" runat="server" ErrorMessage="Please Select" ></asp:RequiredFieldValidator>
                            </p>
                                ...
                                </asp:DropDownList>&nbsp;Whom To Contact<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="DropDownList1" runat="server" ErrorMessage="Enter Subject" ></asp:RequiredFieldValidator>
                            <p>
                                <asp:TextBox ID="TextBox5" runat="server" placeholder="Queries" Height="150px" Width="500" TextMode="MultiLine"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator10" ControlToValidate="TextBox5" runat="server" ErrorMessage="Write your Queries" ></asp:RequiredFieldValidator>
                            </p>
                            <p>
                                <asp:Button ID="Button1" runat="server" Text="Submit" width="50" OnClick="Button1_Click"/>
                                &nbsp;
            ...
            <div id="login">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <li>
                        <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl="~/SignIn.aspx">&raquo;Sign In</asp:HyperLink></li>
